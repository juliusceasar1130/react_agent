#!/usr/bin/env python3
# backend/app/agent/vector/pgvector/vector_store.py
"""
向量存储工具函数
...
from backend.app.agent.vector.pgvector.pgvector_wrapper import PgVectorStoreWrapper
