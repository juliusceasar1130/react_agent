    ...
    <div class="mb-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
      ...
      <div class="flex items-center gap-2">
        <button
          ...
          class="inline-flex items-center rounded-xl border border-neutral-200 bg-white p-2 text-xs font-medium text-neutral-600 shadow-sm transition hover:bg-neutral-50 hover:text-neutral-800 active:scale-98"
          :title="copiedType === 'table' ? '表名已复制' : '复制表名'"
        >
          <svg
