...
<template>
  <div class="flex-1 overflow-y-auto">
    <div v-if="sessions.length === 0" class="p-6 text-center">
      <div class="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-warm-100 mb-3">
      ...
      <p class="text-warm-400 text-sm">暂无会话</p>
      <p class="text-warm-300 text-xs mt-1">点击上方"新建"创建对话</p>
    </div>
